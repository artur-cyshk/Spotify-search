...
import { PLAYLISTS_LIMIT, PLAYLIST_TRACKS_LIMIT, SPOTIFY_METHODS } from '../../constants';
...
export const getPlaylistTracks = (userId, playlistId, page) => {
    return { 
        ...
        spotifyData: {
            ...
            options: [userId, playlistId, { offset: page * PLAYLIST_TRACKS_LIMIT, limit: PLAYLIST_TRACKS_LIMIT }]
        }
    }; 
}
